                                        ...
                                        client.query('SELECT * FROM Menu_All_List WHERE Menu_Main=?',[menu[3]],(error,results4)=>{
                                            if(error){
                                                ...
                                                if(results4[0]==null && menu[3] != '없음'){
                                                    ...
                                                    client.query('UPDATE Menu_Info SET Flame_Menu=?, Course1_Menu=?, Course2_Menu=?, Special_Menu=?, Flame_Origin=?, Course1_Origin=?, Course2_Origin=?, Special_Origin=?, Flame_Price=?, Course1_Price=?, Course2_Price=?, Special_Price=?, Flame_Quantity=?, Course1_Quantity=?, Course2_Quantity=?, Special_Quantity=? WHERE Menu_Date=?',
                                                    [menu[0], menu[1], menu[2], menu[3], results1[0].Origin, results2[0].Origin, results3[0].Origin, results4[0].Origin, results1[0].Price, results2[0].Price, results3[0].Price, results4[0].Price, quantity[0], quantity[1], quantity[2], quantity[3], moment().format('YYYY-MM-DD')], (error)=>{
                                                        if(error){
                                                            console.log(error);
                                                            res.send('<h1>'+'Database ERROR!!!'+'</h1>');
                                                        }else{
